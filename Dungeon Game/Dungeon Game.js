    ...
    "done",
    {
      Dungeon_Room_1: [
        [
          ...
          {
            "c-0": [
              "^ You turn left and keep walking for a little while. ",
              "\n",
              { "->": "Dungeon_Room_2" },
              { "#f": 5 },
            ],
            "c-1": [
              "^ You turn right and keep walking for a little while. ",
              "\n",
              { "->": "Dungeon_Room_3" },
              { "#f": 5 },
            ],
      ...
      Dungeon_Room_2: [
        [
          ...
          "\n",
          "^You barely have the time to turn around, when you see a horrible ",
          [
            "ev",
            "visit",
            3,
            ...
            {
              s0: ["pop", "^orc", { "->": ".^.^.23" }, null],
              s1: ["pop", "^goblin", { "->": ".^.^.23" }, null],
              s2: ["pop", "^gargoyle", { "->": ".^.^.23" }, null],
              "#f": 5,
            },
          ],
          "^ running towards you, with the clear intention to... kill you!",
          "\n",
          "ev",
          "str",
          "^Try to escape",
          ...
          { "*": ".^.c-1", flg: 20 },
          {
            "c-0": [
              "\n",
              "^You try to escape.. and manage to! You end up in a short corridor. ",
              { "->": "Dungeon_Room_3" },
              "\n",
              { "#f": 5 },
            ],
      ...
      Dungeon_Room_3: [
        [
          ...
          "ev",
          "str",
          "^There's a little stair, and you climb it down",
          "/str",
          "/ev",
          { "*": ".^.c-2", flg: 20 },
          {
      ...
      Dungeon_Room_4: [
        [
          ...
          [
            ...
            "nop",
            {
              s0: ["pop", "^two hours", { "->": ".^.^.23" }, null],
              s1: ["pop", "^three hours", { "->": ".^.^.23" }, null],
              s2: ["pop", "^four hours", { "->": ".^.^.23" }, null],
              "#f": 5,
            },
          ],
          "^ have passed, as you kept walking in circles.",
          "\n",
          "ev",
          "str",
          "^Keep walking",
      ...
      Dungeon_Room_5: [
        [
          "^It feels as if you have been walking around for an eternity, you are not sure but ",
          [
            "ev",
            "visit",
            3,
            ...
            "nop",
            {
              s0: ["pop", "^one day", { "->": ".^.^.23" }, null],
              s1: ["pop", "^two days", { "->": ".^.^.23" }, null],
              s2: ["pop", "^three days", { "->": ".^.^.23" }, null],
              "#f": 5,
            },
          ],
          "^ may have passed.",
      ...
      Dungeon_Room_6: [
        ...
        [
          ...
          {
            b: [
              "^ You see a strange drawing on the wall in front of you. It looks like a big triangle with a sword going through it",
              { "->": ".^.^.^.5" },
              null,
            ],
          },
        ...
        [
          ...
          {
            b: [
              "^ You see the same drawing again... a triangle with a sword put through it. What does that mean?",
              { "->": ".^.^.^.11" },
              null,
            ],
          },
